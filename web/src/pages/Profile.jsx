      ...
      <div className="head-row mb-16">
        <div>
          ...
          <p className="sub">
            ...
            Laws, then rules, then this). Seeded once, never overwritten by an update. Prefer not
            to write it by hand? Ask the agent to run the <code className="mono">profile</code>{' '}
            skill — it interviews you and drafts this file with your consent.
          </p>
        </div>
