...
2. Locate the project's own documentation — a `docs/`, `doc/`, `documentation/`,
   ...
   at hand before changing the code they describe ({{DOCTRINE}} process 4) — the
   relevant pages, not the whole tree ({{DOCTRINE}} process 3).
...
5. Update it in the same change whenever structure shifts ({{DOCTRINE}} craft 3).
