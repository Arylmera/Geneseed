...
## Procedure
1. Agree the seams first: name the public interfaces the tests will target and
...
4. Write the minimum code to make it pass; add nothing the test doesn't demand ({{DOCTRINE}} craft 6).
