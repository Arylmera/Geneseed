...
## Procedure
1. Read the current project state and its own docs ({{DOCTRINE}} process 4) so questions are grounded; if the request bundles several systems, decompose and take one at a time.
