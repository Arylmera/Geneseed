...
| **Skills** (24) | repeatable workflows: brainstorm · **clarify** · plan · tdd · debug · refactor · code-review · **fresh-eyes** · **review-response** · commit · **ship** · **release** · **migrate** · **git-archaeology** · **git-rescue** · repo-map · **ingest** · **research** · handoff · roast-me · **council** · parallel-agents · cmux · **workflow** |
...
The official **cmux** CLI skills (`skills/cmux/`, `skills/cmux-workspace/`) are vendored
verbatim from [`manaflow-ai/cmux`](https://github.com/manaflow-ai/cmux) and ship in the
`files`-emit bundle for direct terminal topology control. They are third-party
(GPL-3.0-or-later © Manaflow, Inc.), not counted in the 22 above — see
