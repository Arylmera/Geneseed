...
just a palette file — no code. The full rationale was the `2026-06-17-opencode-color-themes`
spec, a local working document that is not distributed with the repo.
